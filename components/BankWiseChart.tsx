...
export default function BankWiseChart() {
    ...
    return (
        <div className="bg-white rounded-2xl p-6 transition-all duration-200 hover:shadow-[0_4px_16px_rgba(0,0,0,0.08)] hover:-translate-y-1 opacity-0 animate-fadeInUp stagger-5" style={{ boxShadow: '0 2px 8px rgba(0, 0, 0, 0.04)' }}>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Bank-wise Applications</h3>
            <ResponsiveContainer width="100%" height={220}>
                ...
                >
                    ...
                    <XAxis
                        ...
                        tick={{ dy: 5 }}
                    />
                    <YAxis stroke="#9CA3AF" style={{ fontSize: '11px' }} axisLine={false} tickLine={false} width={35} />
                    <Tooltip
                    ...
                    />
                    <Bar dataKey="applications" fill="url(#blueGradient)" radius={[4, 4, 0, 0]} />
                </BarChart>
            </ResponsiveContainer>
        </div>
    );
